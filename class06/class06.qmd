...
One cool thing about R is that it makes writting your own functions comparatively easy.
...
Now put these bits of knowledge together to make some code that identifies and drops the lowest score (element of the the input vector) and then calculates the mean.
